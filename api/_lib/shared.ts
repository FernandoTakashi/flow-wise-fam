 ...
 * (diferente de `splitInstallments`, que é pra parcelas de fatura). O resto
 * em centavos vai 1 a 1 pras primeiras pessoas, em vez de empilhar tudo numa
 * pessoa só — senão, quem sempre cai por último acumula o resto despesa
 * após despesa.
 */
